...
module.exports = function(settings) {
  ...
  return function(sourceBundle, appId, versionId, callback) {
    ...
    }, _.pick(settings, 'logger', 'rubyPath', 'rubyVersion', 'systemGemPath'));
  ...
  function runJekyllBuild(params, callback) {
    var jekyllExecutable = path.join(params.localGemsDirectory, 'ruby', params.rubyVersion, 'bin/jekyll');
    settings.logger.debug('jekyll executable=%s', jekyllExecutable);
