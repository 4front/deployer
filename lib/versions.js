...
module.exports = function(settings) {
  ...
  exports.create = function(versionData, context, callback) {
    ...
    versionData = _.pick(versionData, 'name', 'message', 'manifest', 'deploymentParts');
  ...
  exports.updateStatus = function(versionData, context, options, callback) {
    versionData = _.pick(versionData, 'status', 'versionId',
      'error', 'manifest', 'deploymentParts');
    ...
    settings.database.updateVersion(versionData, function(err, version) {
      ...
      settings.database.updateTrafficRules(
        versionData.appId, environment, trafficRules, function(innerErr) {
        if (err) {
