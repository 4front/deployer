...
module.exports = function(settings) {
  ...
  exports.updateStatus = function(versionData, context, options, callback) {
    ...
    versionData = _.pick(versionData, 'status', 'versionId', 'error');
    versionData.appId = context.virtualApp.appId;

    settings.logger.info("updating version status to %s", versionData.status);
    ...
    settings.database.updateVersion(versionData, function(err, version) {
      ...
      settings.logger.info("updating traffic rules for app %s and environment",
